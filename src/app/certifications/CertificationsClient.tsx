      ...
      <div className="flex flex-wrap items-center gap-6 font-mono text-xs uppercase tracking-widest shrink-0">
        ...
        {cert.credentialUrl && (
          <a
            ...
            className="text-neutral-400 hover:text-accent transition-colors duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent"
          >
            [verify]
          </a>
        )}
        ...
        <Link 
          ...
          className="text-accent hover:text-white transition-colors duration-150 font-bold focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent"
        >
          [details]
        </Link>
