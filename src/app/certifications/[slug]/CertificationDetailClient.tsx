...
export default function CertificationDetailClient() {
  ...
  const isBase64 = certification.image.startsWith('data:');
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 flex flex-col gap-12">
        ...
        <div className="relative w-full aspect-[16/9] md:aspect-[21/9] bg-neutral-900 border border-neutral-800 overflow-hidden">
          <Image
            ...
            alt={`${certification.title} certificate validation image`}
            fill
            sizes="100vw"
            loading="eager"
            priority={true}
          ...
          {certification.credentialUrl && (
            <div className="absolute top-4 right-4">
              <a
                ...
                className="bg-black border border-neutral-800 text-white font-mono text-xs uppercase tracking-widest px-4 py-2 hover:bg-accent hover:text-accent-text hover:border-accent transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent"
              >
                [verify link]
              </a>
            </div>
