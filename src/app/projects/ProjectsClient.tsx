...
export default function ProjectsClient() {
  ...
  const fetchProjects = async () => {
    try {
      ...
      // Silent error in production, log in dev
          ...
          <div className="mt-8 flex flex-wrap items-center gap-6 font-mono text-xs uppercase tracking-widest">
            {project.githubUrl && (
              <a 
                ...
                className="text-white hover:text-accent transition-colors duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent"
              >
                [codebase]
              </a>
            )}
            ...
            <button 
              ...
              className="text-neutral-400 hover:text-white transition-colors duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent"
            >
            ...
            <div className="flex gap-4 border-l border-neutral-900 pl-6">
              <button 
                ...
                className="text-neutral-500 hover:text-accent transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent"
              >
                [edit]
              </button>
              <button 
                onClick={() => { if (project.id) handleDeleteProject(project.id); }} 
                className="text-neutral-500 hover:text-red-500 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent"
              >
                [delete]
              </button>
            </div>
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3 font-mono text-xs uppercase tracking-widest text-neutral-500 border-b border-neutral-900 pb-6">
            {categories.map((cat) => (
              <button
                ...
                className={`transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent ${activeFilter === cat.id ? 'text-accent font-bold' : 'hover:text-white'}`}
              >
